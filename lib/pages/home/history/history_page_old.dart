...
//                     ),
//                     DatePickerCustomV1(
//                       onDateSelected: (date) => context.read<HistoryAttendanceBloc>().add(
...
//                     ),
//                     SortByCustomV1(
//                       onTap: (sortState) => context.read<HistoryAttendanceBloc>().add(
...
//                 const SizedBox(height: 12),
//                 Expanded(
//                   child: BlocBuilder<HistoryAttendanceBloc, HistoryAttendanceState>(
//                     builder: (context, state) {
//                       var attendances = context.read<HistoryAttendanceBloc>().attendances;
