...
class JenisOrgSearchDelegate extends SearchDelegate<DataGeneral?> {
  final List<DataGeneral> dataJenisOrganisasi;
  final List<DataGeneral> filteredData;

  JenisOrgSearchDelegate({
  ...
  Widget buildResults(BuildContext context) {
    final searchResults = dataJenisOrganisasi
        .where((tipeCuti) =>
