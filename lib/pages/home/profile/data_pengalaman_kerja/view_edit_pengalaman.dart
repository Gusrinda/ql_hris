...
class _ViewEditPengalamanPageState extends State<ViewEditPengalamanPage> {
  ...
  void initState() {
    super.initState();
    widget.namaPerusahaanController.text = widget.namaPerusahaan ?? '';
    widget.bidangUsahaController.text = widget.bidangUsaha ?? '';
    widget.noTelpController.text = widget.noTelp ?? '';
    widget.posisiController.text = widget.posisi ?? '';
    widget.tahunMasukController.text = widget.tahunMasuk.toString();
    widget.tahunKeluarController.text = widget.tahunKeluar.toString();
    widget.alamatKantorController.text = widget.alamat ?? '';
    widget.idKotaController.text = widget.idKota.toString();
    widget.valueKotaController.text = widget.valueKota ?? '';
    widget.suratReferensiController.text = widget.suratReferensi ?? '';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<AddPengalamanKerjaBloc, AddPengalamanKerjaState>(
      listener: (context, state) async {
        ...
        } else if (state is EditPengalamanSuccess) {
