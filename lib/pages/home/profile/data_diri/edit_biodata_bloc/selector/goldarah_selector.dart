...
class GolDarahSearchDelegate extends SearchDelegate<DataGeneral?> {
  final List<DataGeneral> dataGolDarah;
  final List<DataGeneral> filteredData;

  GolDarahSearchDelegate({
  ...
  Widget buildResults(BuildContext context) {
    final searchResults = dataGolDarah
        .where((element) =>
