...
class TanggunganSearchDelegate extends SearchDelegate<DataGeneral?> {
  final List<DataGeneral> dataTanggungan;
  final List<DataGeneral> filteredData;

  TanggunganSearchDelegate({
  ...
  Widget buildResults(BuildContext context) {
    final searchResults = dataTanggungan
        .where((element) =>
