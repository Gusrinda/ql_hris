...
class DataDiriControllers {
  ...
  void initializeControllers() {
    ...
    //status nikah
    idStatusPernikahanController?.text =
...
// Tempat Lahir Controller
  final TextEditingController? idTempatLahirController =
      TextEditingController();
...
// Provinsi Controller
  ...
  final TextEditingController? valueProvinsiController =
      TextEditingController();
...
// Kode Pos dan telepon Controller
  ...
  final TextEditingController? noTelpLainnyaController =
      TextEditingController();
  final TextEditingController? noTelpDaruratController =
      TextEditingController();
...
// Gol Darah Controller
  ...
  final TextEditingController? valueGolDarahController =
      TextEditingController();
...
// Info Lain Controller
  ...
  final TextEditingController? jatahCutiKerjaController =
      TextEditingController();
  final TextEditingController? sisaCutiKerjaController =
      TextEditingController();
...
// Berkas Controller
  ...
  final TextEditingController? noBpjsKesehatanController =
      TextEditingController();
  final TextEditingController? noBpjsKetenagakerjaanController =
      TextEditingController();
  final TextEditingController? idTipeBPJSController = TextEditingController();
  final TextEditingController? valueTipeBPJSController =
      TextEditingController();
  final TextEditingController? berkasLainnyaController =
      TextEditingController();
...
// Pembayaran Controller
  final TextEditingController? idPeriodeGajiController =
      TextEditingController();
  ...
  final TextEditingController? valueNamaBankController =
      TextEditingController();
