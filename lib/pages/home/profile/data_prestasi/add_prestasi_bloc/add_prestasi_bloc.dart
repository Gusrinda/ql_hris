    ...
    on<AddDataPrestasiSubmited>((event, emit) async {
      ...
      if (resToken is ServicesSuccess) {
        ...
        if (res is ServicesSuccess) {
          emit(AddDataPrestasiSuccess(message: "Create Data Prestasi Berhassil"));
          print(res.response);
        ...
        emit(AddDataPrestasiFailedUserExpired(message: "Response format is invalid"));
      }
    });
        ...
        if (resToken is ServicesSuccess) {
          ...
          if (res is ServicesSuccess) {
            ...
            if (res.errorResponse == null) {
              await GeneralSharedPreferences.removeUserToken();
              emit(
                  AddDataPrestasiFailedUserExpired(message: "Token expired"));
            } else {
          ...
          emit(
              AddDataPrestasiFailedInBackground(message: 'Response invalid'));
        }
      },
    );
  }
