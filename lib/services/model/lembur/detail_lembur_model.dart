...
part 'detail_lembur_model.freezed.dart';
part 'detail_lembur_model.g.dart';

@freezed
class DetailLemburModel with _$DetailLemburModel {
    const factory DetailLemburModel({
        @JsonKey(name: "data")
        Data? data,
    ...
    factory DetailLemburModel.fromJson(Map<String, dynamic> json) => _$DetailLemburModelFromJson(json);
}
