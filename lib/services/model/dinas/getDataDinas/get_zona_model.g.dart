...
part of 'get_zona_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$GetZonaModelImpl _$$GetZonaModelImplFromJson(Map<String, dynamic> json) =>
    _$GetZonaModelImpl(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => DataZona.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$GetZonaModelImplToJson(_$GetZonaModelImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
...
_$DataZonaImpl _$$DataZonaImplFromJson(Map<String, dynamic> json) =>
    _$DataZonaImpl(
      ...
      datumMTunjKemahalanId: json['m_tunj_kemahalan_id'] as int?,
      ...
      mTunjKemahalanId: json['m_tunj_kemahalan.id'] as int?,
      mTunjKemahalanMCompId: json['m_tunj_kemahalan.m_comp_id'] as int?,
      mTunjKemahalanMDirId: json['m_tunj_kemahalan.m_dir_id'] as int?,
      mTunjKemahalanKode: json['m_tunj_kemahalan.kode'] as String?,
      mTunjKemahalanMDivisiId: json['m_tunj_kemahalan.m_divisi_id'] as int?,
      mTunjKemahalanMDeptId: json['m_tunj_kemahalan.m_dept_id'] as int?,
      mTunjKemahalanMZonaId: json['m_tunj_kemahalan.m_zona_id'],
      mTunjKemahalanMPosisiId: json['m_tunj_kemahalan.m_posisi_id'] as int?,
      mTunjKemahalanBesaran: json['m_tunj_kemahalan.besaran'] as String?,
      mTunjKemahalanDesc: json['m_tunj_kemahalan.desc'] as String?,
      mTunjKemahalanIsActive: json['m_tunj_kemahalan.is_active'] as bool?,
      mTunjKemahalanCreatorId: json['m_tunj_kemahalan.creator_id'],
      mTunjKemahalanLastEditorId: json['m_tunj_kemahalan.last_editor_id'],
      mTunjKemahalanCreatedAt: json['m_tunj_kemahalan.created_at'] as String?,
      mTunjKemahalanUpdatedAt: json['m_tunj_kemahalan.updated_at'] as String?,
...
Map<String, dynamic> _$$DataZonaImplToJson(_$DataZonaImpl instance) =>
    <String, dynamic>{
      ...
      'm_tunj_kemahalan_id': instance.datumMTunjKemahalanId,
      'kode': instance.kode,
      'nama': instance.nama,
      'desc': instance.desc,
      ...
      'm_tunj_kemahalan.id': instance.mTunjKemahalanId,
      'm_tunj_kemahalan.m_comp_id': instance.mTunjKemahalanMCompId,
      'm_tunj_kemahalan.m_dir_id': instance.mTunjKemahalanMDirId,
      'm_tunj_kemahalan.kode': instance.mTunjKemahalanKode,
      'm_tunj_kemahalan.m_divisi_id': instance.mTunjKemahalanMDivisiId,
      'm_tunj_kemahalan.m_dept_id': instance.mTunjKemahalanMDeptId,
      'm_tunj_kemahalan.m_zona_id': instance.mTunjKemahalanMZonaId,
      'm_tunj_kemahalan.m_posisi_id': instance.mTunjKemahalanMPosisiId,
      'm_tunj_kemahalan.besaran': instance.mTunjKemahalanBesaran,
      'm_tunj_kemahalan.desc': instance.mTunjKemahalanDesc,
      'm_tunj_kemahalan.is_active': instance.mTunjKemahalanIsActive,
      'm_tunj_kemahalan.creator_id': instance.mTunjKemahalanCreatorId,
      'm_tunj_kemahalan.last_editor_id': instance.mTunjKemahalanLastEditorId,
      'm_tunj_kemahalan.created_at': instance.mTunjKemahalanCreatedAt,
      'm_tunj_kemahalan.updated_at': instance.mTunjKemahalanUpdatedAt,
