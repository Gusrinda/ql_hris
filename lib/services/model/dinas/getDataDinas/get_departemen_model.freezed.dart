...
GetDepartemenModel _$GetDepartemenModelFromJson(Map<String, dynamic> json) {
  return _GetDepartemenModel.fromJson(json);
}

/// @nodoc
mixin _$GetDepartemenModel {
  @JsonKey(name: "data")
  List<DataDepartemen>? get data => throw _privateConstructorUsedError;
  @JsonKey(name: "total")
  ...
  @JsonKey(ignore: true)
  $GetDepartemenModelCopyWith<GetDepartemenModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetDepartemenModelCopyWith<$Res> {
  factory $GetDepartemenModelCopyWith(
          GetDepartemenModel value, $Res Function(GetDepartemenModel) then) =
      _$GetDepartemenModelCopyWithImpl<$Res, GetDepartemenModel>;
  @useResult
  $Res call(
      {@JsonKey(name: "data") List<DataDepartemen>? data,
...
/// @nodoc
class _$GetDepartemenModelCopyWithImpl<$Res, $Val extends GetDepartemenModel>
    implements $GetDepartemenModelCopyWith<$Res> {
  _$GetDepartemenModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetDepartemenModelImplCopyWith<$Res>
    implements $GetDepartemenModelCopyWith<$Res> {
  factory _$$GetDepartemenModelImplCopyWith(_$GetDepartemenModelImpl value,
          $Res Function(_$GetDepartemenModelImpl) then) =
      __$$GetDepartemenModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "data") List<DataDepartemen>? data,
...
/// @nodoc
class __$$GetDepartemenModelImplCopyWithImpl<$Res>
    extends _$GetDepartemenModelCopyWithImpl<$Res, _$GetDepartemenModelImpl>
    implements _$$GetDepartemenModelImplCopyWith<$Res> {
  __$$GetDepartemenModelImplCopyWithImpl(_$GetDepartemenModelImpl _value,
      $Res Function(_$GetDepartemenModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetDepartemenModelImpl(
      data: freezed == data
          ? _value._data
          : data // ignore: cast_nullable_to_non_nullable
              as List<DataDepartemen>?,
...
/// @nodoc
@JsonSerializable()
class _$GetDepartemenModelImpl implements _GetDepartemenModel {
  const _$GetDepartemenModelImpl(
      {@JsonKey(name: "data") final List<DataDepartemen>? data,
  ...
  factory _$GetDepartemenModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetDepartemenModelImplFromJson(json);

  final List<DataDepartemen>? _data;
  @override
  @JsonKey(name: "data")
  List<DataDepartemen>? get data {
    final value = _data;
  ...
  @override
  String toString() {
    return 'GetDepartemenModel(data: $data, total: $total, currentPage: $currentPage, perPage: $perPage, from: $from, to: $to, lastPage: $lastPage, hasNext: $hasNext, prev: $prev, next: $next, processedTime: $processedTime)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetDepartemenModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetDepartemenModelImplCopyWith<_$GetDepartemenModelImpl> get copyWith =>
      __$$GetDepartemenModelImplCopyWithImpl<_$GetDepartemenModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetDepartemenModelImplToJson(
      this,
    );
  }
}

abstract class _GetDepartemenModel implements GetDepartemenModel {
  const factory _GetDepartemenModel(
          {@JsonKey(name: "data") final List<DataDepartemen>? data,
  ...
  factory _GetDepartemenModel.fromJson(Map<String, dynamic> json) =
      _$GetDepartemenModelImpl.fromJson;
...
DataDepartemen _$DataDepartemenFromJson(Map<String, dynamic> json) {
  return _DataDepartemen.fromJson(json);
}

/// @nodoc
mixin _$DataDepartemen {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $DataDepartemenCopyWith<DataDepartemen> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DataDepartemenCopyWith<$Res> {
  factory $DataDepartemenCopyWith(
          DataDepartemen value, $Res Function(DataDepartemen) then) =
      _$DataDepartemenCopyWithImpl<$Res, DataDepartemen>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DataDepartemenCopyWithImpl<$Res, $Val extends DataDepartemen>
    implements $DataDepartemenCopyWith<$Res> {
  _$DataDepartemenCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DataDepartemenImplCopyWith<$Res>
    implements $DataDepartemenCopyWith<$Res> {
  factory _$$DataDepartemenImplCopyWith(_$DataDepartemenImpl value,
          $Res Function(_$DataDepartemenImpl) then) =
      __$$DataDepartemenImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "meta_read") bool? metaRead,
...
/// @nodoc
class __$$DataDepartemenImplCopyWithImpl<$Res>
    extends _$DataDepartemenCopyWithImpl<$Res, _$DataDepartemenImpl>
    implements _$$DataDepartemenImplCopyWith<$Res> {
  __$$DataDepartemenImplCopyWithImpl(
      _$DataDepartemenImpl _value, $Res Function(_$DataDepartemenImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DataDepartemenImpl(
      metaRead: freezed == metaRead
          ? _value.metaRead
          : metaRead // ignore: cast_nullable_to_non_nullable
              as bool?,
...
/// @nodoc
@JsonSerializable()
class _$DataDepartemenImpl implements _DataDepartemen {
  const _$DataDepartemenImpl(
  ...
  factory _$DataDepartemenImpl.fromJson(Map<String, dynamic> json) =>
      _$$DataDepartemenImplFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.mDivisiMCompId, mDivisiMCompId) ||
                other.mDivisiMCompId == mDivisiMCompId) &&
            (identical(other.mDivisiMDirId, mDivisiMDirId) ||
                other.mDivisiMDirId == mDivisiMDirId) &&
            (identical(other.mDivisiNama, mDivisiNama) ||
                other.mDivisiNama == mDivisiNama) &&
            (identical(other.mDivisiDesc, mDivisiDesc) ||
                other.mDivisiDesc == mDivisiDesc) &&
            (identical(other.mDivisiIsActive, mDivisiIsActive) ||
                other.mDivisiIsActive == mDivisiIsActive) &&
            (identical(other.mDivisiCreatorId, mDivisiCreatorId) ||
                other.mDivisiCreatorId == mDivisiCreatorId) &&
            (identical(other.mDivisiLastEditorId, mDivisiLastEditorId) ||
                other.mDivisiLastEditorId == mDivisiLastEditorId) &&
            (identical(other.mDivisiCreatedAt, mDivisiCreatedAt) ||
                other.mDivisiCreatedAt == mDivisiCreatedAt) &&
            (identical(other.mDivisiUpdatedAt, mDivisiUpdatedAt) ||
                other.mDivisiUpdatedAt == mDivisiUpdatedAt) &&
            ...
            const DeepCollectionEquality()
                .equals(other.creatorEmailVerifiedAt, creatorEmailVerifiedAt) &&
            const DeepCollectionEquality()
                .equals(other.creatorPassword, creatorPassword) &&
            const DeepCollectionEquality()
                .equals(other.creatorMCompId, creatorMCompId) &&
            const DeepCollectionEquality()
                .equals(other.creatorMDirId, creatorMDirId) &&
            const DeepCollectionEquality()
                .equals(other.creatorIsActive, creatorIsActive) &&
            const DeepCollectionEquality()
                .equals(other.creatorCreatorId, creatorCreatorId) &&
            const DeepCollectionEquality()
                .equals(other.creatorLastEditorId, creatorLastEditorId) &&
            const DeepCollectionEquality()
                .equals(other.creatorRememberToken, creatorRememberToken) &&
            const DeepCollectionEquality()
                .equals(other.creatorCreatedAt, creatorCreatedAt) &&
            const DeepCollectionEquality()
                .equals(other.creatorUpdatedAt, creatorUpdatedAt) &&
            const DeepCollectionEquality()
                .equals(other.creatorProfilImage, creatorProfilImage) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DataDepartemenImplCopyWith<_$DataDepartemenImpl> get copyWith =>
      __$$DataDepartemenImplCopyWithImpl<_$DataDepartemenImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DataDepartemenImplToJson(
      this,
    );
  }
}

abstract class _DataDepartemen implements DataDepartemen {
  const factory _DataDepartemen(
      ...
      @JsonKey(name: "last_editor.m_kary_id")
      final dynamic lastEditorMKaryId}) = _$DataDepartemenImpl;

  factory _DataDepartemen.fromJson(Map<String, dynamic> json) =
      _$DataDepartemenImpl.fromJson;
