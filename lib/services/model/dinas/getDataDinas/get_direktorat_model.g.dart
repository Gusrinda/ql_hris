...
_$GetDirektoratModelImpl _$$GetDirektoratModelImplFromJson(
        Map<String, dynamic> json) =>
    _$GetDirektoratModelImpl(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => DataDirektorat.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$GetDirektoratModelImplToJson(
        _$GetDirektoratModelImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
...
_$DataDirektoratImpl _$$DataDirektoratImplFromJson(Map<String, dynamic> json) =>
    _$DataDirektoratImpl(
...
Map<String, dynamic> _$$DataDirektoratImplToJson(
        _$DataDirektoratImpl instance) =>
    <String, dynamic>{
