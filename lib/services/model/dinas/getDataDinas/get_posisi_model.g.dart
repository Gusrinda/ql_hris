...
part of 'get_posisi_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$GetPosisiModelImpl _$$GetPosisiModelImplFromJson(Map<String, dynamic> json) =>
    _$GetPosisiModelImpl(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => DataPosisi.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$GetPosisiModelImplToJson(
        _$GetPosisiModelImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
...
_$DataPosisiImpl _$$DataPosisiImplFromJson(Map<String, dynamic> json) =>
    _$DataPosisiImpl(
      ...
      descKerja: json['desc_kerja'] as String?,
      descKerja1: json['desc_kerja_1'] as String?,
      descKerja2: json['desc_kerja_2'] as String?,
      minPengalaman: json['min_pengalaman'] as String?,
      datumMinPendidikanId: json['min_pendidikan_id'] as int?,
      minGajiPokok: json['min_gaji_pokok'] as int?,
      maxGajiPokok: json['max_gaji_pokok'] as int?,
      biaya: json['biaya'],
      datumTipeBpjsId: json['tipe_bpjs_id'] as int?,
      potonganBpjs: json['potongan_bpjs'] as int?,
      ...
      minPendidikanId: json['min_pendidikan.id'] as int?,
      minPendidikanMCompId: json['min_pendidikan.m_comp_id'] as int?,
      minPendidikanMDirId: json['min_pendidikan.m_dir_id'],
      minPendidikanGroup: json['min_pendidikan.group'] as String?,
      minPendidikanKey: json['min_pendidikan.key'] as String?,
      minPendidikanCode: json['min_pendidikan.code'] as String?,
      minPendidikanValue: json['min_pendidikan.value'] as String?,
      minPendidikanIsActive: json['min_pendidikan.is_active'] as bool?,
      minPendidikanCreatorId: json['min_pendidikan.creator_id'],
      minPendidikanLastEditorId: json['min_pendidikan.last_editor_id'],
      minPendidikanCreatedAt: json['min_pendidikan.created_at'] as String?,
      minPendidikanUpdatedAt: json['min_pendidikan.updated_at'] as String?,
      minPendidikanValue2: json['min_pendidikan.value_2'],
      minPendidikanValue3: json['min_pendidikan.value_3'],
      tipeBpjsId: json['tipe_bpjs.id'] as int?,
      tipeBpjsMCompId: json['tipe_bpjs.m_comp_id'] as int?,
      tipeBpjsMDirId: json['tipe_bpjs.m_dir_id'],
      tipeBpjsGroup: json['tipe_bpjs.group'] as String?,
      tipeBpjsKey: json['tipe_bpjs.key'] as String?,
      tipeBpjsCode: json['tipe_bpjs.code'] as String?,
      tipeBpjsValue: json['tipe_bpjs.value'] as String?,
      tipeBpjsIsActive: json['tipe_bpjs.is_active'] as bool?,
      tipeBpjsCreatorId: json['tipe_bpjs.creator_id'],
      tipeBpjsLastEditorId: json['tipe_bpjs.last_editor_id'],
      tipeBpjsCreatedAt: json['tipe_bpjs.created_at'] as String?,
      tipeBpjsUpdatedAt: json['tipe_bpjs.updated_at'] as String?,
      tipeBpjsValue2: json['tipe_bpjs.value_2'],
      tipeBpjsValue3: json['tipe_bpjs.value_3'],
...
Map<String, dynamic> _$$DataPosisiImplToJson(_$DataPosisiImpl instance) =>
    <String, dynamic>{
      ...
      'kode': instance.kode,
      'desc_kerja': instance.descKerja,
      'desc_kerja_1': instance.descKerja1,
      'desc_kerja_2': instance.descKerja2,
      'min_pengalaman': instance.minPengalaman,
      'min_pendidikan_id': instance.datumMinPendidikanId,
      'min_gaji_pokok': instance.minGajiPokok,
      'max_gaji_pokok': instance.maxGajiPokok,
      'biaya': instance.biaya,
      'tipe_bpjs_id': instance.datumTipeBpjsId,
      'potongan_bpjs': instance.potonganBpjs,
      'desc': instance.desc,
      ...
      'min_pendidikan.id': instance.minPendidikanId,
      'min_pendidikan.m_comp_id': instance.minPendidikanMCompId,
      'min_pendidikan.m_dir_id': instance.minPendidikanMDirId,
      'min_pendidikan.group': instance.minPendidikanGroup,
      'min_pendidikan.key': instance.minPendidikanKey,
      'min_pendidikan.code': instance.minPendidikanCode,
      'min_pendidikan.value': instance.minPendidikanValue,
      'min_pendidikan.is_active': instance.minPendidikanIsActive,
      'min_pendidikan.creator_id': instance.minPendidikanCreatorId,
      'min_pendidikan.last_editor_id': instance.minPendidikanLastEditorId,
      'min_pendidikan.created_at': instance.minPendidikanCreatedAt,
      'min_pendidikan.updated_at': instance.minPendidikanUpdatedAt,
      'min_pendidikan.value_2': instance.minPendidikanValue2,
      'min_pendidikan.value_3': instance.minPendidikanValue3,
      'tipe_bpjs.id': instance.tipeBpjsId,
      'tipe_bpjs.m_comp_id': instance.tipeBpjsMCompId,
      'tipe_bpjs.m_dir_id': instance.tipeBpjsMDirId,
      'tipe_bpjs.group': instance.tipeBpjsGroup,
      'tipe_bpjs.key': instance.tipeBpjsKey,
      'tipe_bpjs.code': instance.tipeBpjsCode,
      'tipe_bpjs.value': instance.tipeBpjsValue,
      'tipe_bpjs.is_active': instance.tipeBpjsIsActive,
      'tipe_bpjs.creator_id': instance.tipeBpjsCreatorId,
      'tipe_bpjs.last_editor_id': instance.tipeBpjsLastEditorId,
      'tipe_bpjs.created_at': instance.tipeBpjsCreatedAt,
      'tipe_bpjs.updated_at': instance.tipeBpjsUpdatedAt,
      'tipe_bpjs.value_2': instance.tipeBpjsValue2,
      'tipe_bpjs.value_3': instance.tipeBpjsValue3,
