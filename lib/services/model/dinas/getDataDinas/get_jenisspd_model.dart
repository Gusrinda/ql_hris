...
part 'get_jenisspd_model.freezed.dart';
part 'get_jenisspd_model.g.dart';

@freezed
class GetJenisSpdModel with _$GetJenisSpdModel {
    const factory GetJenisSpdModel({
        @JsonKey(name: "data")
        List<DataJenisSpd>? data,
        @JsonKey(name: "total")
        int? total,
    ...
    factory GetJenisSpdModel.fromJson(Map<String, dynamic> json) => _$GetJenisSpdModelFromJson(json);
}

@freezed
class DataJenisSpd with _$DataJenisSpd {
    const factory DataJenisSpd({
    ...
    factory DataJenisSpd.fromJson(Map<String, dynamic> json) => _$DataJenisSpdFromJson(json);
}
