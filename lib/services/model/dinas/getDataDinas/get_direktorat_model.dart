...
part 'get_direktorat_model.freezed.dart';
part 'get_direktorat_model.g.dart';

@freezed
class GetDirektoratModel with _$GetDirektoratModel {
    const factory GetDirektoratModel({
        @JsonKey(name: "data")
        List<DataDirektorat>? data,
        @JsonKey(name: "total")
        int? total,
    ...
    factory GetDirektoratModel.fromJson(Map<String, dynamic> json) => _$GetDirektoratModelFromJson(json);
}

@freezed
class DataDirektorat with _$DataDirektorat {
    const factory DataDirektorat({
    ...
    factory DataDirektorat.fromJson(Map<String, dynamic> json) => _$DataDirektoratFromJson(json);
}
