...
_$ResponseDetailSpdImpl _$$ResponseDetailSpdImplFromJson(
        Map<String, dynamic> json) =>
    _$ResponseDetailSpdImpl(
      data: json['data'] == null
          ? null
          : DataDetailDinas.fromJson(json['data'] as Map<String, dynamic>),
      processedTime: (json['processed_time'] as num?)?.toDouble(),
    );

Map<String, dynamic> _$$ResponseDetailSpdImplToJson(
        _$ResponseDetailSpdImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
      'processed_time': instance.processedTime,
    };

_$DataDetailDinasImpl _$$DataDetailDinasImplFromJson(
        Map<String, dynamic> json) =>
    _$DataDetailDinasImpl(
      id: json['id'] as int?,
      nomor: json['nomor'] as String?,
      dataMCompId: json['m_comp_id'] as int?,
      dataMSpdId: json['m_spd_id'] as int?,
      dataMDirId: json['m_dir_id'] as int?,
      dataMDivisiId: json['m_divisi_id'] as int?,
      dataMDeptId: json['m_dept_id'] as int?,
      dataMPosisiId: json['m_posisi_id'] as int?,
      tanggal: json['tanggal'] as String?,
      tglAcaraAwal: json['tgl_acara_awal'] as String?,
      tglAcaraAkhir: json['tgl_acara_akhir'] as String?,
      dataJenisSpdId: json['jenis_spd_id'] as int?,
      dataMZonaAsalId: json['m_zona_asal_id'] as int?,
      dataMZonaTujuanId: json['m_zona_tujuan_id'] as int?,
      dataMLokasiTujuanId: json['m_lokasi_tujuan_id'] as int?,
      dataMKaryId: json['m_kary_id'] as int?,
      dataPicId: json['pic_id'] as int?,
      totalBiaya: json['total_biaya'] as int?,
      kegiatan: json['kegiatan'] as String?,
      keterangan: json['keterangan'] as String?,
      status: json['status'] as String?,
      dataCreatorId: json['creator_id'] as int?,
      dataLastEditorId: json['last_editor_id'],
      ...
      mKaryTanggunganId: json['m_kary.tanggungan_id'],
      ...
      mKaryLimitPotong: json['m_kary.limit_potong'],
      mKaryAtasanId: json['m_kary.atasan_id'],
      ...
      picNoTlpLainnya: json['pic.no_tlp_lainnya'] as String?,
      ...
      picTglMasuk: json['pic.tgl_masuk'] as String?,
      ...
      tSpdDet: json['t_spd_det'] as List<dynamic>?,
    );

Map<String, dynamic> _$$DataDetailDinasImplToJson(
        _$DataDetailDinasImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'nomor': instance.nomor,
      'm_comp_id': instance.dataMCompId,
      'm_spd_id': instance.dataMSpdId,
      'm_dir_id': instance.dataMDirId,
      'm_divisi_id': instance.dataMDivisiId,
      'm_dept_id': instance.dataMDeptId,
      'm_posisi_id': instance.dataMPosisiId,
      'tanggal': instance.tanggal,
      'tgl_acara_awal': instance.tglAcaraAwal,
      'tgl_acara_akhir': instance.tglAcaraAkhir,
      'jenis_spd_id': instance.dataJenisSpdId,
      'm_zona_asal_id': instance.dataMZonaAsalId,
      'm_zona_tujuan_id': instance.dataMZonaTujuanId,
      'm_lokasi_tujuan_id': instance.dataMLokasiTujuanId,
      'm_kary_id': instance.dataMKaryId,
      'pic_id': instance.dataPicId,
