...
_$DataDetailDinasImpl _$$DataDetailDinasImplFromJson(
    ...
    _$DataDetailDinasImpl(
      ...
      picProfilImage: json['pic.profil_image'] as String?,
      picTelp: json['pic.telp'] as String?,
      ...
      detBiaya: (json['det_biaya'] as List<dynamic>?)
          ?.map((e) => DetBiaya.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$DataDetailDinasImplToJson(
    ...
    <String, dynamic>{
      ...
      'det_biaya': instance.detBiaya,
      't_spd_det': instance.tSpdDet,
    };

_$DetBiayaImpl _$$DetBiayaImplFromJson(Map<String, dynamic> json) =>
    _$DetBiayaImpl(
      totalBiaya: json['total_biaya'] as String?,
      tipeId: json['tipe_id'] as int?,
      keterangan: json['keterangan'] as String?,
      tipeValue: json['tipe_value'] as String?,
    );

Map<String, dynamic> _$$DetBiayaImplToJson(_$DetBiayaImpl instance) =>
    <String, dynamic>{
      'total_biaya': instance.totalBiaya,
      'tipe_id': instance.tipeId,
      'keterangan': instance.keterangan,
      'tipe_value': instance.tipeValue,
    };
