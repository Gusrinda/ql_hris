...
_$BiodataImpl _$$BiodataImplFromJson(Map<String, dynamic> json) =>
    _$BiodataImpl(
      ...
      mStandartGajiId: json['m_standart_gaji_id'],
      periodeGajiId: json['periode_gaji_id'],
      refId: json['ref_id'],
      ...
      bpjsNo: json['bpjs_no'],
      bpjsFoto: json['bpjs_foto'],
      berkasLain: json['berkas_lain'] as String?,
      descFile: json['desc_file'],
      periodeGaji: json['periode_gaji'] as String?,
      metode: json['metode'] as String?,
      metodeId: json['metode_id'] as int?,
      tipe: json['tipe'] as String?,
      tipeId: json['tipe_id'] as int?,
      bank: json['bank'] as String?,
      bankId: json['bank_id'] as int?,
      noRek: json['no_rek'] as String?,
      atasNamaRek: json['atas_nama_rek'] as String?,
    );
...
Map<String, dynamic> _$$BiodataImplToJson(_$BiodataImpl instance) =>
    <String, dynamic>{
      ...
      'periode_gaji': instance.periodeGaji,
      'metode': instance.metode,
      'metode_id': instance.metodeId,
      'tipe': instance.tipe,
      'tipe_id': instance.tipeId,
      'bank': instance.bank,
      'bank_id': instance.bankId,
      'no_rek': instance.noRek,
      'atas_nama_rek': instance.atasNamaRek,
    };
