...
part 'response_kota.freezed.dart';
part 'response_kota.g.dart';

@freezed
class ResponseKota with _$ResponseKota {
    const factory ResponseKota({
        @JsonKey(name: "data")
        List<DataKota>? data,
        @JsonKey(name: "total")
        int? total,
    ...
    factory ResponseKota.fromJson(Map<String, dynamic> json) => _$ResponseKotaFromJson(json);
}

@freezed
class DataKota with _$DataKota {
    const factory DataKota({
    ...
    factory DataKota.fromJson(Map<String, dynamic> json) => _$DataKotaFromJson(json);
}
