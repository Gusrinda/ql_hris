...
part 'response_general.freezed.dart';
part 'response_general.g.dart';

@freezed
class ResponseGeneral with _$ResponseGeneral {
    const factory ResponseGeneral({
        @JsonKey(name: "data")
        List<DataGeneral>? data,
        @JsonKey(name: "total")
        int? total,
    ...
    factory ResponseGeneral.fromJson(Map<String, dynamic> json) => _$ResponseGeneralFromJson(json);
}
