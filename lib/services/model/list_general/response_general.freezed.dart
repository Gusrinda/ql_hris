...
ResponseGeneral _$ResponseGeneralFromJson(Map<String, dynamic> json) {
  return _ResponseGeneral.fromJson(json);
}

/// @nodoc
mixin _$ResponseGeneral {
  @JsonKey(name: "data")
  ...
  @JsonKey(ignore: true)
  $ResponseGeneralCopyWith<ResponseGeneral> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ResponseGeneralCopyWith<$Res> {
  factory $ResponseGeneralCopyWith(
          ResponseGeneral value, $Res Function(ResponseGeneral) then) =
      _$ResponseGeneralCopyWithImpl<$Res, ResponseGeneral>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ResponseGeneralCopyWithImpl<$Res, $Val extends ResponseGeneral>
    implements $ResponseGeneralCopyWith<$Res> {
  _$ResponseGeneralCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ResponseGeneralImplCopyWith<$Res>
    implements $ResponseGeneralCopyWith<$Res> {
  factory _$$ResponseGeneralImplCopyWith(_$ResponseGeneralImpl value,
          $Res Function(_$ResponseGeneralImpl) then) =
      __$$ResponseGeneralImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "data") List<DataGeneral>? data,
...
/// @nodoc
class __$$ResponseGeneralImplCopyWithImpl<$Res>
    extends _$ResponseGeneralCopyWithImpl<$Res, _$ResponseGeneralImpl>
    implements _$$ResponseGeneralImplCopyWith<$Res> {
  __$$ResponseGeneralImplCopyWithImpl(
      _$ResponseGeneralImpl _value, $Res Function(_$ResponseGeneralImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ResponseGeneralImpl(
      data: freezed == data
          ? _value._data
          : data // ignore: cast_nullable_to_non_nullable
              as List<DataGeneral>?,
...
/// @nodoc
@JsonSerializable()
class _$ResponseGeneralImpl implements _ResponseGeneral {
  const _$ResponseGeneralImpl(
  ...
  factory _$ResponseGeneralImpl.fromJson(Map<String, dynamic> json) =>
      _$$ResponseGeneralImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ResponseGeneral(data: $data, total: $total, currentPage: $currentPage, perPage: $perPage, from: $from, to: $to, lastPage: $lastPage, hasNext: $hasNext, prev: $prev, next: $next, processedTime: $processedTime)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ResponseGeneralImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ResponseGeneralImplCopyWith<_$ResponseGeneralImpl> get copyWith =>
      __$$ResponseGeneralImplCopyWithImpl<_$ResponseGeneralImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ResponseGeneralImplToJson(
      this,
    );
  }
}

abstract class _ResponseGeneral implements ResponseGeneral {
  const factory _ResponseGeneral(
          {@JsonKey(name: "data") final List<DataGeneral>? data,
      ...
      _$ResponseGeneralImpl;

  factory _ResponseGeneral.fromJson(Map<String, dynamic> json) =
      _$ResponseGeneralImpl.fromJson;
...
abstract class _DataGeneral implements DataGeneral {
  const factory _DataGeneral(
      ...
      @JsonKey(name: "last_editor.m_kary_id")
      final dynamic lastEditorMKaryId}) = _$DataGeneralImpl;
