...
part 'response_tingkat_pendidikan.freezed.dart';
part 'response_tingkat_pendidikan.g.dart';

@freezed
class ResponseTingkatPendidikan with _$ResponseTingkatPendidikan {
    const factory ResponseTingkatPendidikan({
        @JsonKey(name: "data")
        List<DataTingkat>? data,
        @JsonKey(name: "total")
        int? total,
    ...
    }) = _ResponseTingkatPendidikan;

    factory ResponseTingkatPendidikan.fromJson(Map<String, dynamic> json) => _$ResponseTingkatPendidikanFromJson(json);
}

@freezed
class DataTingkat with _$DataTingkat {
    const factory DataTingkat({
    ...
    factory DataTingkat.fromJson(Map<String, dynamic> json) => _$DataTingkatFromJson(json);
}
