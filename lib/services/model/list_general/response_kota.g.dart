...
_$ResponseKotaImpl _$$ResponseKotaImplFromJson(Map<String, dynamic> json) =>
    _$ResponseKotaImpl(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => DataKota.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$ResponseKotaImplToJson(_$ResponseKotaImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
...
_$DataKotaImpl _$$DataKotaImplFromJson(Map<String, dynamic> json) =>
    _$DataKotaImpl(
...
Map<String, dynamic> _$$DataKotaImplToJson(_$DataKotaImpl instance) =>
    <String, dynamic>{
